...
// NOT: AdsManager import'unu sildik, aşağıda tam isimle kullanacağız.
...
public class StoreActivity extends AppCompatActivity {
    ...
    // --- DÜZELTME: Tam paket ismini (com.haxlite.iapads.AdsManager) yazarak karışıklığı önledik ---
    private com.goalrift.football.iapads.AdsManager adsManager;

    // UI öğeleri
    private TextView jetonText;

    // --- Ücretsiz Jeton Butonu ---
    private Button btnFreeJeton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // --- DÜZELTME: Burada da tam paket ismini kullanıyoruz ---
        adsManager = new com.goalrift.football.iapads.AdsManager(this);
        adsManager.init(); // Reklamı önceden yüklemeye başlar
        ...
        // --- BANNER REKLAM ---
        AdView adView = findViewById(R.id.adViewStore);
        if (adView != null) {
            AdRequest adRequest = new AdRequest.Builder().build();
            adView.loadAd(adRequest);
        }

        // --- Ücretsiz Jeton Butonu İşlevi ---
        btnFreeJeton = findViewById(R.id.btnFreeJeton);
        btnFreeJeton.setOnClickListener(this::onClick);
